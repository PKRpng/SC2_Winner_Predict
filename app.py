...
def main():       
    ...
    if st.button("Random Map"): 
        ...
        map1Name = st.selectbox('Map 1',map_data.maps, map_data.maps[45])

        map2Name = st.selectbox('Map 2',map_data.maps, map_data.maps[74])

        map3Name = st.selectbox('Map 3',map_data.maps, map_data.maps[78])
